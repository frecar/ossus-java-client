...
public class Installer {
    ...
    private static Map<String, Map<String, String>> inputFileMap = new HashMap<>();
    private static Map<String, String> outFileMap = new HashMap<>();

    static {

        inputFileMap.put("Mac OS X", new HashMap<>());
        inputFileMap.get("Mac OS X").put("x86_64", "libsigar-universal64-macosx.dylib");
        outFileMap.put("Mac OS X", "/usr/lib/java/");

        inputFileMap.put("Linux", new HashMap<>());
        ...
        inputFileMap.put("Windows XP", new HashMap<>());
        ...
        inputFileMap.put("Windows 7", new HashMap<>());
        ...
        inputFileMap.put("Windows Vista", new HashMap<>());
        ...
        inputFileMap.put("Windows 2003", new HashMap<>());
        ...
        inputFileMap.put("Windows Server 2008", new HashMap<>());
